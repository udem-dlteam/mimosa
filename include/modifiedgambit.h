...
#define ___HAVE_GOOD_COSH
#define ___HAVE_GOOD_TANH
#define ___HAVE_GOOD_POW
#define ___HAVE_GOOD_ATAN2
...
#define ___BIGAANDC1(x,i,y,j) \
___BIGATEMP= ~___BIGAFETCH(___BODY_AS(x,___tSUBTYPED),(i)>>___TB) & ___BIGAFETCH(___BODY_AS(y,___tSUBTYPED),(j)>>___TB); \
___BIGASTORE(___BODY_AS(x,___tSUBTYPED),(i)>>___TB,(___BIGADIGIT)___BIGATEMP);

#define ___BIGAANDC2(x,i,y,j) \
___BIGATEMP= ___BIGAFETCH(___BODY_AS(x,___tSUBTYPED),(i)>>___TB) & ~___BIGAFETCH(___BODY_AS(y,___tSUBTYPED),(j)>>___TB); \
___BIGASTORE(___BODY_AS(x,___tSUBTYPED),(i)>>___TB,(___BIGADIGIT)___BIGATEMP);

#define ___BIGAEQV(x,i,y,j) \
___BIGATEMP= ~(___BIGAFETCH(___BODY_AS(x,___tSUBTYPED),(i)>>___TB) ^ ___BIGAFETCH(___BODY_AS(y,___tSUBTYPED),(j)>>___TB)); \
___BIGASTORE(___BODY_AS(x,___tSUBTYPED),(i)>>___TB,(___BIGADIGIT)___BIGATEMP);
...
#define ___BIGANAND(x,i,y,j) \
___BIGATEMP= ~(___BIGAFETCH(___BODY_AS(x,___tSUBTYPED),(i)>>___TB) & ___BIGAFETCH(___BODY_AS(y,___tSUBTYPED),(j)>>___TB)); \
___BIGASTORE(___BODY_AS(x,___tSUBTYPED),(i)>>___TB,(___BIGADIGIT)___BIGATEMP);

#define ___BIGANOR(x,i,y,j) \
___BIGATEMP= ~(___BIGAFETCH(___BODY_AS(x,___tSUBTYPED),(i)>>___TB) | ___BIGAFETCH(___BODY_AS(y,___tSUBTYPED),(j)>>___TB)); \
___BIGASTORE(___BODY_AS(x,___tSUBTYPED),(i)>>___TB,(___BIGADIGIT)___BIGATEMP);
...
#define ___BIGAORC1(x,i,y,j) \
___BIGATEMP= ~___BIGAFETCH(___BODY_AS(x,___tSUBTYPED),(i)>>___TB) | ___BIGAFETCH(___BODY_AS(y,___tSUBTYPED),(j)>>___TB); \
___BIGASTORE(___BODY_AS(x,___tSUBTYPED),(i)>>___TB,(___BIGADIGIT)___BIGATEMP);

#define ___BIGAORC2(x,i,y,j) \
___BIGATEMP= ___BIGAFETCH(___BODY_AS(x,___tSUBTYPED),(i)>>___TB) | ~___BIGAFETCH(___BODY_AS(y,___tSUBTYPED),(j)>>___TB); \
___BIGASTORE(___BODY_AS(x,___tSUBTYPED),(i)>>___TB,(___BIGADIGIT)___BIGATEMP);
...
#define ___FIXANDC1(x,y)((___WORD)(~(x)&(y)))
#define ___FIXANDC2(x,y)((___WORD)((x)&~(y)))
#define ___FIXEQV(x,y)((___WORD)(((x)^(y))^~___TMASK))
#define ___FIXIOR(x,y)((___WORD)((x)|(y)))
#define ___FIXNAND(x,y)((___WORD)(((x)&(y))^~___TMASK))
#define ___FIXNOR(x,y)((___WORD)(((x)|(y))^~___TMASK))
#define ___FIXNOT(x)((___WORD)((x)^~___TMASK))
#define ___FIXORC1(x,y)((___WORD)(((x)^~___TMASK)|(y)))
#define ___FIXORC2(x,y)((___WORD)((x)|((y)^~___TMASK)))
...
#define ___PORT_EVENT_CONDVAR        48

#define ___PORT_DEVICE_OTHER1        49
#define ___PORT_DEVICE_OTHER2        50
...
#define ___F64LOG2(x,y)(___CLIBEXT(log)(x)/___CLIBEXT(log)(y))
...
#define ___F64HYPOT(x,y)___CLIBEXT(hypot)(x,y)
#else
#define ___F64HYPOT(x,y)___EXT(___hypot)(x,y)
#endif
...
#ifdef ___USE_ISINF
#define ___F64INFINITEP(x)___EXT(___isinf)(x)
#else
...
#define ___TICKETLOCK_INIT_STATIC { ___FIX(0), ___FIX(0) }
...
#define ___SPINLOCK_INIT_STATIC ___MUTEX_INIT_STATIC
...
#define ___SPINLOCK_INIT_STATIC ___TICKETLOCK_INIT_STATIC
...
#define ___CLO_LOWLEVEL_TRAMPOLINE_SETUP(ptr,lbl) \
do { \
     /* generate ARM THUMB2 instructions: mov r4,pc ; ldr pc,[r4,#-8] */ \
     (ptr)[___LABEL_LOWLEVEL_CODE] = 0xf854467cL; \
     (ptr)[___LABEL_LOWLEVEL_CODE+1] = 0x0000fc08L; \
   } while (0)

#define ___LABEL_LOWLEVEL_TRAMPOLINE_SIZE 1
#define ___LABEL_LOWLEVEL_TRAMPOLINE_SETUP(ptr) \
do { \
     /* generate ARM THUMB2 instructions: ldr r7,[r5] ; blx r7 */ \
     (ptr)[___LABEL_LOWLEVEL_CODE] = 0x47b8682fL; \
   } while (0)
...
#define ___CLO_LOWLEVEL_TRAMPOLINE_SETUP(ptr,lbl) \
do { \
     /* XXX generate RISC-V instructions: auipc s6, 0x0; ld s6, -16(s6); jr s6 */ \
     (ptr)[___LABEL_LOWLEVEL_CODE] = 0xff0b3b0300000b17L; \
     (ptr)[___LABEL_LOWLEVEL_CODE+1] = 0x000b0067; \
   } while (0)

#define ___LABEL_LOWLEVEL_TRAMPOLINE_SIZE 1
#define ___LABEL_LOWLEVEL_TRAMPOLINE_SETUP(ptr) \
do { \
     /* generate RISC-V instructions: ld s7, 0(s10); jalr s7 */ \
     (ptr)[___LABEL_LOWLEVEL_CODE] = 0x000b80e7000d3b83L; \
   } while (0)

#else

#define ___CLO_LOWLEVEL_TRAMPOLINE_SIZE 3
#define ___CLO_LOWLEVEL_TRAMPOLINE_SETUP(ptr,lbl) \
do { \
     /* generate RISC-V instructions: auipc s6, 0x0; lw s6, -8(s6); jr s6 */ \
     (ptr)[___LABEL_LOWLEVEL_CODE] = 0x00000b17; \
     (ptr)[___LABEL_LOWLEVEL_CODE+1] = 0xff8b2b03; \
     (ptr)[___LABEL_LOWLEVEL_CODE+2] = 0x000b0067; \
   } while (0)

#define ___LABEL_LOWLEVEL_TRAMPOLINE_SIZE 2
#define ___LABEL_LOWLEVEL_TRAMPOLINE_SETUP(ptr) \
do { \
     /* generate RISC-V instructions: lw s7, 0(s10); jalr s7 */ \
     (ptr)[___LABEL_LOWLEVEL_CODE] = 0x000d2b83; \
     (ptr)[___LABEL_LOWLEVEL_CODE+1] = 0x000b80e7; \
   } while (0)
...
#define ___MODULE_DESCR_SUPPLY_MODS   0
#define ___MODULE_DESCR_DEMAND_MODS   1
#define ___MODULE_DESCR_META_INFO     2
#define ___MODULE_DESCR_FLAGS         3
#define ___MODULE_DESCR_THUNK         4
#define ___MODULE_DESCR_MODULE_STRUCT 5
...
#define ___MUTEX_INIT_STATIC PTHREAD_MUTEX_INITIALIZER
...
#define ___CONDVAR_INIT_STATIC PTHREAD_COND_INITIALIZER
...
#define ___MUTEX_DECL(id) ___MUTEX id;
#define ___MUTEX_INIT_STATIC NULL
...
#define ___CONDVAR_DECL(id) ___CONDVAR id;
#define ___CONDVAR_INIT_STATIC CONDITION_VARIABLE_INIT
...
#define ___CONDVAR_DECL(id) ___CONDVAR id;
#define ___CONDVAR_INIT_STATIC 0
...
typedef struct ___virtual_machine_state_struct
  {
    ...
    ___SCMOBJ main_module_ref; /* symbol identifying the VM's main module */
...
#define ___DEBUG_SETTINGS_REPL_MASK           (7<<7)
#define ___DEBUG_SETTINGS_REPL_CONSOLE        0
#define ___DEBUG_SETTINGS_REPL_STDIO          1
#define ___DEBUG_SETTINGS_REPL_STDIO_AND_ERR  2
#define ___DEBUG_SETTINGS_REPL_CLIENT         3
#define ___DEBUG_SETTINGS_REPL_SHIFT          7
#define ___DEBUG_SETTINGS_USER_INTR_MASK      (3<<10)
...
#define ___MODULE_INSTALL_MODE_ASK_WHEN_REPL 1
#define ___MODULE_INSTALL_MODE_ASK_ALWAYS    2
