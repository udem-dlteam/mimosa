...
(define-library
  ...
  (begin
    ...
    (define PS2-B-SW1 (expt 2 7))
    (define PS2-B-TKT (expt 2 6))
    (define PS2-B-NME (expt 2 5))
    (define PS2-B-NMI (expt 2 4))
    (define PS2-B-REC (expt 2 3))
    (define PS2-B-SW2 (expt 2 2))
    (define PS2-B-SPK (expt 2 1))
    (define PS2-B-RSG (expt 2 0))
    (define PS2-C-PAR (expt 2 7))
    (define PS2-C-ERW (expt 2 6))
    (define PS2-C-TIM (expt 2 5))
    (define PS2-C-TON (expt 2 4))
    (define PS2-C-HS5 (expt 2 3))
    (define PS2-C-HS4 (expt 2 2))
    (define PS2-C-HS3 (expt 2 1))
    (define PS2-C-HS2-HS6 (expt 2 0))
    (define PS2-PARE (expt 2 7))
    (define PS2-TIM (expt 2 6))
    (define PS2-AUXB (expt 2 5))
    (define PS2-KEYL (expt 2 4))
    (define PS2-C-D (expt 2 3))
    (define PS2-SYSF (expt 2 2))
    (define PS2-INPB (expt 2 1))
    (define PS2-OUTB (expt 2 0))
    ...
    (define PS2-CONFIG-SCAN-CONVERT    (expt 2 6))
    (define PS2-CONFIG-AUXB-CLOCK-DISABLE (expt 2 5))
    (define PS2-CONFIG-KBD-CLOCK-DISABLE (expt 2 4))
    (define PS2-CONFIG-SYSF        (expt 2 2))
    (define PS2-CONFIG-ENABLE-IRQ12    (expt 2 1))
    (define PS2-CONFIG-ENABLE-IRQ1    (expt 2 0))
    ...
    (define scancodes
      (vector
        ...
        DEAD DEAD DEAD DEAD NULL
        #x3b00 #x5400 #x5e00 #x6800 (string->list "\033OP")
        #x3c00 #x5500 #x5f00 #x6900 (string->list "\033OQ")
        #x3d00 #x5600 #x6000 #x6a00 (string->list "\033OR")
        #x3e00 #x5700 #x6100 #x6b00 (string->list "\033OS")
        #x3f00 #x5800 #x6200 #x6c00 (string->list "\033[15~")
        #x4000 #x5900 #x6300 #x6d00 (string->list "\033[17~")
        #x4100 #x5a00 #x6400 #x6e00 (string->list "\033[18~")
        #x4200 #x5b00 #x6500 #x6f00 (string->list "\033[19~")
        #x4300 #x5c00 #x6600 #x7000 (string->list "\033[20~")
        #x4400 #x5d00 #x6700 #x7100 (string->list "\033[21~")
        DEAD DEAD DEAD DEAD NULL
        DEAD DEAD DEAD DEAD NULL
        #x4700 #x4737 #x7700 DEAD (string->list "\033[H")
        #x4800 #x4838 DEAD DEAD (string->list "\033[A")
        #x4900 #x4939 #x8400 DEAD NULL
        #x4a2d #x4a2d DEAD DEAD NULL
        #x4b00 #x4b34 #x7300 DEAD (string->list "\033[D")
        #x4c00 #x4c35 DEAD DEAD NULL
        #x4d00 #x4d36 #x7400 DEAD (string->list "\033[C")
        #x4e2b #x4e2b DEAD DEAD NULL
        #x4f00 #x4f31 #x7500 DEAD (string->list "\033[F")
        #x5000 #x5032 DEAD DEAD (string->list "\033[B")
        #x5100 #x5133 #x7600 DEAD NULL
        #x5200 #x5230 DEAD DEAD (string->list "\033[2~")
        #x5300 #x532e DEAD DEAD NULL
        DEAD DEAD DEAD DEAD NULL
        DEAD DEAD DEAD DEAD NULL
        DEAD DEAD DEAD DEAD NULL
        DEAD DEAD DEAD DEAD (string->list "\033[23~")
        DEAD DEAD DEAD DEAD (string->list "\033[24~")
        ))
